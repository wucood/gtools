...
# 初始化CentOS
curl -s https://raw.githubusercontent.com/wucood/gtools/main/conf/version.conf > temp_version.conf
source temp_version.conf
curl -s https://raw.githubusercontent.com/wucood/gtools/main/conf/option.conf > temp_option.conf
source temp_option.conf
